...
echo "Testing Qwen (WAV)..."
python -u evaluate_on_synthetic.py --model Qwen --mode stateless_chunk --ext wav

echo "Testing Qwen (MP3)..."
python -u evaluate_on_synthetic.py --model Qwen --mode stateless_chunk --ext mp3

echo "Testing Qwen (OGG)..."
python -u evaluate_on_synthetic.py --model Qwen --mode stateless_chunk --ext ogg
