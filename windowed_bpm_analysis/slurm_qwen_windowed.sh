...
python -u compute_windowed_rmse.py --model Qwen --mode stateless_chunk

echo "Running Qwen (C1: True History)"
python -u compute_windowed_rmse.py --model Qwen --mode true_history

echo "Running Qwen (C2: Fake History)"
python -u compute_windowed_rmse.py --model Qwen --mode fake_history

echo "Running Qwen (C3: Full Song)"
python -u compute_windowed_rmse.py --model Qwen --mode full_song
