#!/usr/bin/env python3
"""
train_flamingo_bpm_lora.py
=========================
Fine-tunes Music-Flamingo on BPM extraction.
...
OUTPUT_DIR = "/data/mg546924/models/music-flamingo-lora-bpm"
...
def main():
    ...
    # ── Training Loop ──
    loss_log = []
    print(f"\n{'='*60}\nStarting Music-Flamingo BPM Training: {NUM_EPOCHS} Epochs\n{'='*60}")
    ...
    print(f"\n Music-Flamingo BPM Training Complete! Saved to {OUTPUT_DIR}")
