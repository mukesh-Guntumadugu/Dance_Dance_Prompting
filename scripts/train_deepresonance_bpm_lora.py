#!/usr/bin/env python3
"""
train_deepresonance_bpm_lora.py
==============================
Fine-tunes DeepResonance on BPM extraction using its native
...
OUTPUT_DIR = "/data/mg546924/models/deepresonance-lora-bpm"
...
def main():
    ...
    full_dataset = BPMDataset(DATASET_JSONL, tokenizer, MAX_LENGTH)
    ...
    loss_log = []
    print(f"\n{'='*60}")
    print(f"Starting DeepResonance BPM Training: {NUM_EPOCHS} Epochs")
    print(f"{'='*60}")
    ...
    print(f"\n✅ DeepResonance BPM Training Complete! Final model saved to {OUTPUT_DIR}")
